            ...
            for table in tables:
                for record in table.records:
                    ...
                    if values.get("layers_1_name") == "IP":
                        for field in irrelevant_fields_for_ip:
                            values.pop(field, None)
